...
os.environ["GROQ_API_KEY"] = groq_api_key# Initialize embeddings model
...
st.set_page_config(page_title="CQ ANNOTATION MANVAL QA", layout="centered")
st.title("💬 CQ ANNOTATION MANVAL QA")
